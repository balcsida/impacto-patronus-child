				...
				?><div class="team_member_description"><?php
                    ...
                    if ( $need_info ) {
                        ...
                        <div class="team_member_brief_info">
                            <h5 class="team_member_brief_info_title"><?php esc_attr_e('Brief info', 'impacto-patronus'); ?></h5>
                    ...
                    if ( $need_socials ) {
                        ?><div class="team_member_socials socials_wrap"><span class="team_member_socials_label"><?php esc_attr_e('Socials:', 'impacto-patronus'); ?></span><?php trx_addons_show_layout(trx_addons_get_socials_links_custom($meta['socials'])); ?></div><?php
                    }
				?>
				<a href="/noar-stab" class="sc_button sc_button_default sc_button_size_normal sc_button_hover_slide_left">Stáb</a>
				</div>
			</div><?php
		}
